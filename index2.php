	...
	<body>
		...
		<div id="main">
						...
						<div class="section">
				            <div class="container-fluid">
				                <div>				                				                	
				                	<h2>Downloads</h2>				                			                	
				                	<br>	
				                	<button class="button2" onclick="location.href='https://drive.google.com/open?id=19_gRrnrjCp78NfRk4lY2b-W5A4XLn5xY'" style="width: 200px;"><span>Download (.exe)</span></button>		       	
				                	<button class="button2" onclick="location.href='https://drive.google.com/open?id=1Iw_0Iq4Qev8QPUBscAWTMvbYdqZJADMD'" style="width: 200px;"><span>Download (.zip)</span></button>
				                	<button class="button2" onclick="location.href='game/sm64tt_v1_source.txt'" style="width: 200px;"><span>Download (.txt)</span></button>
				                	<br>
				                	<p>Walkthrough, so Mr. Krnic can actually see the end of the game without having to waste time dying a million times. Happy teacher = good mark</p>
				                	<br>
			...
			<div class="footer">
				...
				<p>
					<a href="http://the404.ml/">the404</a> <img src="img/logofullinvert.png" width="30px"> © 2018
				</p>
			</div>
		</div>
